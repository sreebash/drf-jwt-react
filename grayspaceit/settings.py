...
SECRET_KEY = '{{SreeBash}}q6gt_q-os$#+1^(%kl0a!y)gg9#nbj3c56)3i8e)p=tr9=*@q)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['0.0.0.0', 'localhost', 'deploy-jwt-blog-app.herokuapp.com']
...
INSTALLED_APPS = [
    ...
    'rest_framework',  # Other third-party framework
    'corsheaders',  # For drf and react communication
    'authentication',  # Our custom authentication app
    'posts',  # Our custom posts app
